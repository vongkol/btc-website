                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        cols="30" rows="3" class="form-control">{{$news->short_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <P></P>
                                <img src="{{asset('uploads/news/'.$news->featured_image)}}" alt="" class="imimage" id="img" width="120">
                            </div>
                        </div>
                       <div class="row">
                           <div class="col-sm-12">
                               ...
                               cols="30" rows="10" class="form-control">{{$news->description}}</textarea>
                               <P></P>
