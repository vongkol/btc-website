                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                    ...
                                    <textarea name="name" id="name" class="form-control" rows="3">{{$slide->name}}</textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="photo" class="control-label required col-lg-2 col-sm-2">Image  <span class="text-danger">(1350 x 550)</span></label>
                            <div class="col-lg-6 col-sm-8">
